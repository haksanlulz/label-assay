...
- **Speed.** The earlier tool took 30–40 seconds per label, so reviewers went back to checking by eye. One terse model call plus microseconds of deterministic checking stays inside the 5-second target.
